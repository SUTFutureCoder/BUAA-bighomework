...
class SIXrayDetection(data.Dataset):
    ...
    def __init__(self,
                 ...
                 anno_path=None, image_path=None,
                 dataset_name='SIXray'):
        # self.root = root
        ...
        if anno_path == None:
            ...
            self._annopath = osp.join('%s', anno_path, '%s.txt')
        ...
        if image_path == None:
            ...
            self._imgpath = osp.join('%s', image_path, '%s.TIFF')
            self._imgpath1 = osp.join('%s', image_path, '%s.tiff')
            self._imgpath_jpg = osp.join('%s', image_path, '%s.jpg')
        ...
        if type(self.image_set) == list:
            self.ids = self.image_set
        else:
